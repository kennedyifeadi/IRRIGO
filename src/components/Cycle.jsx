    ...
    <div className="w-[90%] rounded-md flex justify-between shadow-md py-2 px-4 bg-white mt-5">
      ...
      <h1 className="font-bold text-[24px] text-[#333333]">Cycle</h1>
        <div className="flex gap-1 items-center">
          <span className={`text-[#333333] text-[36px] ${clicked ? "animate-spin" : ""}`}><GiCycle /></span>
      ...
      <div className="justify-center items-center flex ">
          <button className="bg-[#64B5F6] rounded-lg active:scale-90 duration-200 ease-in-out px-4 text-white py-2" onClick={bottonClicked}>Restart</button>
      </div>
    </div>
  )
}
